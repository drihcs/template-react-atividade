      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-4">
            <Link to="/" className="text-xl font-semibold text-primary-500 flex items-center gap-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Elevating web experiences with beautifully crafted interfaces and seamless interactions.
            </p>
          ...
          <div className="space-y-4">
            ...
            <form className="flex mt-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-l-md bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                required
              />
              <motion.button
                type="submit"
